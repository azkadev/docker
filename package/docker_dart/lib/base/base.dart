...
abstract class DockerEngineBaseCore {}

abstract class DockerEngineBase implements DockerEngineBaseCore {

  final String dockerEngineApi;
  final bool isPrivilage;
  DockerEngineBase({
    required this.dockerEngineApi,
    required this.isPrivilage,
  });

  Uri getHostDocker({
    Uri? hostDockerEngineApi,
  }) {
    return hostDockerEngineApi ??= Uri.parse(dockerEngineApi);
  }
